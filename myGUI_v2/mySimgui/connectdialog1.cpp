    ...
    ui(new Ui::ConnectDialog)
{
    ...
    connect(&SimWindow1::m_socket,&QTcpSocket::connected,[=](){
        QString sendstr= "connect ";
        SimWindow1::m_socket.write(sendstr.toUtf8().data()); //发送消息
        connectflag = true;
...
void ConnectDialog::on_connect_btn_clicked()
{
    ...
    if (connectflag==false)
    {
        ...
        //与服务器连接
        SimWindow1::m_socket.connectToHost(IP,Port);
    ...
    {
        //与服务器断开连接
        SimWindow1::m_socket.disconnectFromHost();
