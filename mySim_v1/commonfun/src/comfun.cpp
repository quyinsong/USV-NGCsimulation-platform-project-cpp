...
void COMFUN::myWAMVplot(Matrix<float,2,1> pos, float psi)
{
    //无人艇参数
    float L = 5;  // length
    float BOA = 2; //width
    ...
    //船体坐标系下无人艇浮筒模型边界点
    Matrix<float,2,1> left_translate; //左浮筒偏移距离
    Matrix<float,2,1> right_translate; //右浮筒偏移距离
    left_translate<< 0, -B/2;
    right_translate = -left_translate;
    //船体坐标系下无人艇无偏移浮筒模型边界点
    Matrix<float,2,1> xb_hull1;
    Matrix<float,2,1> xb_hull2;
    Matrix<float,2,1> xb_hull3;
    Matrix<float,2,1> xb_hull4;
    Matrix<float,2,1> xb_hull5;
    float L1 = L/2;
    ...
    //船体坐标系下无人艇左浮筒模型边界点
    Matrix<float,2,1> xb_left_hull1;
    Matrix<float,2,1> xb_left_hull2;
    Matrix<float,2,1> xb_left_hull3;
    Matrix<float,2,1> xb_left_hull4;
    Matrix<float,2,1> xb_left_hull5;
    ...
    //船体坐标系下无人艇右浮筒模型边界点
    Matrix<float,2,1> xb_right_hull1;
    Matrix<float,2,1> xb_right_hull2;
    Matrix<float,2,1> xb_right_hull3;
    Matrix<float,2,1> xb_right_hull4;
    Matrix<float,2,1> xb_right_hull5;
    ...
    //将左浮筒边界点转到世界坐标系
    Matrix<float,2,1> xn_left_hull1;
    Matrix<float,2,1> xn_left_hull2;
    Matrix<float,2,1> xn_left_hull3;
    Matrix<float,2,1> xn_left_hull4;
    Matrix<float,2,1> xn_left_hull5;
    ...
    //将右浮筒边界点转到世界坐标系
    Matrix<float,2,1> xn_right_hull1;
    Matrix<float,2,1> xn_right_hull2;
    Matrix<float,2,1> xn_right_hull3;
    Matrix<float,2,1> xn_right_hull4;
    Matrix<float,2,1> xn_right_hull5;
    ...
    plt::plot(xplt_left1,yplt_left1,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_left2,yplt_left2,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_left3,yplt_left3,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_left4,yplt_left4,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_left5,yplt_left5,{{"color", "red"}, {"linestyle", "-"}}); 
    ...
    plt::plot(xplt_right1,yplt_right1,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_right2,yplt_right2,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_right3,yplt_right3,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_right4,yplt_right4,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_right5,yplt_right5,{{"color", "red"}, {"linestyle", "-"}}); 

    //计算四个横梁边界点
    //船体坐标系下无人艇无偏移横梁模型边界点
    Matrix<float,2,1> xb_center_beam1;
    Matrix<float,2,1> xb_center_beam2;
    Matrix<float,2,1> xb_center_beam3;
    Matrix<float,2,1> xb_center_beam4;
    float Lbe1 = L/20;
    ...
    //计算左1偏移横梁
    Matrix<float,2,1> le1_translate; //偏移坐标
    Matrix<float,2,1> xb_le1_beam1; 
    Matrix<float,2,1> xb_le1_beam2;
    Matrix<float,2,1> xb_le1_beam3;
    Matrix<float,2,1> xb_le1_beam4;
    ...
    //计算左2偏移横梁
    Matrix<float,2,1> le2_translate; //偏移坐标
    Matrix<float,2,1> xb_le2_beam1; 
    Matrix<float,2,1> xb_le2_beam2;
    Matrix<float,2,1> xb_le2_beam3;
    Matrix<float,2,1> xb_le2_beam4;
    ...
    //计算右1偏移横梁
    Matrix<float,2,1> rg1_translate; //偏移坐标
    Matrix<float,2,1> xb_rg1_beam1; 
    Matrix<float,2,1> xb_rg1_beam2;
    Matrix<float,2,1> xb_rg1_beam3;
    Matrix<float,2,1> xb_rg1_beam4;
    ...
    //计算右2偏移横梁
    Matrix<float,2,1> rg2_translate; //偏移坐标
    Matrix<float,2,1> xb_rg2_beam1; 
    Matrix<float,2,1> xb_rg2_beam2;
    Matrix<float,2,1> xb_rg2_beam3;
    Matrix<float,2,1> xb_rg2_beam4;
    ...
    //将四个横梁边界点转到世界坐标系
    Matrix<float,2,1> xn_le1_beam1;
    Matrix<float,2,1> xn_le1_beam2;
    Matrix<float,2,1> xn_le1_beam3;
    Matrix<float,2,1> xn_le1_beam4;
    ...
    Matrix<float,2,1> xn_le2_beam1;
    Matrix<float,2,1> xn_le2_beam2;
    Matrix<float,2,1> xn_le2_beam3;
    Matrix<float,2,1> xn_le2_beam4;
    ...
    Matrix<float,2,1> xn_rg1_beam1;
    Matrix<float,2,1> xn_rg1_beam2;
    Matrix<float,2,1> xn_rg1_beam3;
    Matrix<float,2,1> xn_rg1_beam4;
    ...
    Matrix<float,2,1> xn_rg2_beam1;
    Matrix<float,2,1> xn_rg2_beam2;
    Matrix<float,2,1> xn_rg2_beam3;
    Matrix<float,2,1> xn_rg2_beam4;
    ...
    plt::plot(xplt_le1_beam1,yplt_le1_beam1,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_le1_beam2,yplt_le1_beam2,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_le1_beam3,yplt_le1_beam3,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_le1_beam4,yplt_le1_beam4,{{"color", "red"}, {"linestyle", "-"}});
    ...
    plt::plot(xplt_le2_beam1,yplt_le2_beam1,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_le2_beam2,yplt_le2_beam2,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_le2_beam3,yplt_le2_beam3,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_le2_beam4,yplt_le2_beam4,{{"color", "red"}, {"linestyle", "-"}});
    ...
    plt::plot(xplt_rg1_beam1,yplt_rg1_beam1,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_rg1_beam2,yplt_rg1_beam2,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_rg1_beam3,yplt_rg1_beam3,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_rg1_beam4,yplt_rg1_beam4,{{"color", "red"}, {"linestyle", "-"}});
    ...
    plt::plot(xplt_rg2_beam1,yplt_rg2_beam1,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_rg2_beam2,yplt_rg2_beam2,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_rg2_beam3,yplt_rg2_beam3,{{"color", "red"}, {"linestyle", "-"}});
    plt::plot(xplt_rg2_beam4,yplt_rg2_beam4,{{"color", "red"}, {"linestyle", "-"}});
}
